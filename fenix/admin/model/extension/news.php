...
class ModelExtensionNews extends Model {
	public function addNews($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "news SET image = '" . $this->db->escape($data['image']) . "', date_added = NOW(), status = '" . (int)$data['status'] . "', youtube = '" . $this->db->escape($data['youtube']) . "', fb = '" . $this->db->escape($data['fb']) . "', vk = '" . $this->db->escape($data['vk']) . "', insta = '" . $this->db->escape($data['insta']) . "'");
	...
	public function editNews($news_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "news SET image = '" . $this->db->escape($data['image']) . "', status = '" . (int)$data['status'] . "', youtube = '" . $this->db->escape($data['youtube']) . "', fb = '" . $this->db->escape($data['fb']) . "', vk = '" . $this->db->escape($data['vk']) . "', insta = '" . $this->db->escape($data['insta']) . "' WHERE news_id = '" . (int)$news_id . "'");
