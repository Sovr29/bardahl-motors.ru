      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
          	<li class="active"><a href="#tab-cart" data-toggle="tab">1. <?php echo $tab_product; ?></a></li>
            <li><a href="#tab-customer" data-toggle="tab">2. <?php echo $tab_customer; ?></a></li>
            <li><a href="#tab-total" data-toggle="tab">3. <?php echo $tab_total; ?></a></li>
          </ul>
          <div class="tab-content">
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      <td class="text-left"><?php echo $order_product['name']; ?><br />
                        ...
                        <?php } ?>
                        <?php } ?></td>
                      <td class="text-left"><?php echo $order_product['sku']; ?></td>
            ...
            <div class="tab-pane hidden" id="tab-payment">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="firstname" value="<?php echo (strlen($payment_firstname)>0? $payment_firstname : 'не указано'); ?>" id="input-payment-firstname" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="lastname" value="<?php echo (strlen($payment_lastname)>0? $payment_lastname : 'не указано'); ?>" id="input-payment-lastname" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="address_1" value="<?php echo (strlen($payment_address_1)>0 ? $payment_address_1 : 'не заполнено'); ?>" id="input-payment-address-1" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="city" value="<?php echo (strlen($payment_city)>0 ? $payment_city:'не указано'); ?>" id="input-payment-city" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
	                ...
	                <?php }else{ ?>
	                	<input name="country_id" id="input-payment-country" type="text" value="176"/>
	                <?php }?>
                </div>
              </div>
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="zone_id" id="input-payment-zone" class="form-control" type="text" value="<?php echo $payment_zone_id>0?$payment_zone_id:50; ?>"/>
                </div>
              </div>
              <?php foreach ($custom_fields as $custom_field) { ?>
            ...
            <div class="tab-pane hidden" id="tab-shipping">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="city" value="<?php echo (strlen($shipping_city)>0?$shipping_city:'не указано'); ?>" id="input-shipping-city" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input name="zone_id" id="input-shipping-zone" class="form-control" type="text" value="<?php echo $shipping_zone_id>0?$shipping_zone_id:50; ?>"/>
                </div>
              </div>
              <?php foreach ($custom_fields as $custom_field) { ?>
              <?php if ($custom_field['location'] == 'address') { ?>
...
function checkShipping(clickedTab)
{
	$.ajax({
		...
		type: 'post',
		data: $('#tab-shipping input[type=\'text\'], #tab-shipping input[type=\'hidden\'], #tab-shipping input[type=\'radio\']:checked, #tab-shipping input[type=\'checkbox\']:checked, #tab-shipping select, #tab-shipping textarea, #tab-customer input[type=\'text\'], #tab-customer input[type=\'hidden\'], #tab-customer input[type=\'radio\']:checked, #tab-customer input[type=\'checkbox\']:checked, #tab-customer select, #tab-customer textarea'),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['error']) {
								...
								for (i in json['shipping_methods']) {
									if (!json['shipping_methods'][i]['error']) {
										for (j in json['shipping_methods'][i]['quote']) {
											var code = json['shipping_methods'][i]['quote'][j]['code'];
											if(s === '' || code.indexOf(s) === -1)
											{
												if(s !== '')
												{
													html += '</optgroup>';
												...
												s = code.split('.')[0];
												html += '<optgroup label="' + json['shipping_methods'][i]['quote'][j]['title'] + '">';
											}
											if (code == $('select[name=\'shipping_method\'] option:selected').val()) {
												html += '<option value="' + code + '" selected="selected">' + json['shipping_methods'][i]['quote'][j]['address'] + '</option>';
											} else {
												html += '<option value="' + code + '">' + json['shipping_methods'][i]['quote'][j]['address'] + '</option>';
											}
										}		
									} else {
				...
				if(clickedTab !== undefined && clickedTab !== null)
				{
					// Refresh products, vouchers and totals
					$('#button-refresh').trigger('click');
					$('a[href=\'' + clickedTab + '\']').tab('show');
				}					
			}
		},
		error: function(xhr, ajaxOptions, thrownError) {
...
function checkPayment(clickedTab)
{
	$.ajax({
		...
		type: 'post',
		data: $('#tab-payment input[type=\'text\'], #tab-payment input[type=\'hidden\'], #tab-payment input[type=\'radio\']:checked, #tab-payment input[type=\'checkbox\']:checked, #tab-payment select, #tab-payment textarea, #tab-customer input[type=\'text\'], #tab-customer input[type=\'hidden\'], #tab-customer input[type=\'radio\']:checked, #tab-customer input[type=\'checkbox\']:checked, #tab-customer select, #tab-customer textarea'),
		dataType: 'json',
		success: function(json) {
			$('.alert, .text-danger').remove();
			$('.form-group').removeClass('has-error');
...
$('document').ready(function(){
	...
	$('#order a[data-toggle=\'tab\']').on('click', function(e) {
		if($('#order li.active a').prop('hash') !== '#tab-cart')
		{
			checkTabs($(this).prop('hash'));
			return false;
		}
	});
	$('#input-shipping-address-1').on('change', function(){
		checkPayment();
	});
});
		...
		success: function(json) {
			...
			if (json['products']) {
				for (i = 0; i < json['products'].length; i++) {
					...
					html += '</td>';
					html += '  <td class="text-left">' + product['sku'] + '</td>';
...
$('#button-save').on('click', function() {
	...
	$.ajax({
		url: url,
		type: 'post',
		data: $('#tab-total select[name=\'order_status_id\'], select, #tab-total textarea[name=\'comment\'], #tab-total input[name=\'affiliate_id\']'),
		dataType: 'json',
		beforeSend: function() {
