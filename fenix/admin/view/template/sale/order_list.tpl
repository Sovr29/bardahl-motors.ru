              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_modified') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left nowrap"><?php echo $column_comment; ?></td>
