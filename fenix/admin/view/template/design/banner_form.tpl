          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $entry_link_title; ?></td>                
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left" style="width: 30%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][link_title]" value="<?php echo $banner_image['link_title']; ?>" placeholder="<?php echo $entry_link_title; ?>" class="form-control" /></td>
...
function addImage() {
	...
	html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][link_title]" value="" placeholder="<?php echo $entry_link_title; ?>" class="form-control" /></td>';	
