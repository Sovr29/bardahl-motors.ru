              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($product_type['type_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $product_type['name']; ?></td>
                  <td class="text-left"><?php echo $product_type['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $product_type['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
