              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-admission<?php echo $language['language_id']; ?>"><?php echo $entry_admission; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][admission]" placeholder="<?php echo $entry_admission; ?>" id="input-admission<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['admission'] : ''; ?></textarea>
                    </div>
                  </div>
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-technical_info<?php echo $language['language_id']; ?>"><?php echo $entry_technical_info; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][technical_info]" placeholder="<?php echo $entry_technical_info; ?>" id="input-technical_info<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['technical_info'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $entry_europe_quality; ?></label>
                    <div class="col-sm-10">
                      <label class="radio-inline">
                        <?php if ($product_description[$language['language_id']]['europe_quality']) { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][europe_quality]" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                        <?php } else { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][europe_quality]" value="1" />
                        <?php echo $text_yes; ?>
                        <?php } ?>
                      </label>
                      <label class="radio-inline">
                        <?php if (!$product_description[$language['language_id']]['europe_quality']) { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][europe_quality]" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                        <?php } else { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][europe_quality]" value="0" />
                        <?php echo $text_no; ?>
                        <?php } ?>
                      </label>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $entry_profitably; ?></label>
                    <div class="col-sm-10">
                      <label class="radio-inline">
                        <?php if ($product_description[$language['language_id']]['profitably']) { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][profitably]" value="1" checked="checked" />
                        <?php echo $text_yes; ?>
                        <?php } else { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][profitably]" value="1" />
                        <?php echo $text_yes; ?>
                        <?php } ?>
                      </label>
                      <label class="radio-inline">
                        <?php if (!$product_description[$language['language_id']]['profitably']) { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][profitably]" value="0" checked="checked" />
                        <?php echo $text_no; ?>
                        <?php } else { ?>
                        <input type="radio" name="product_description[<?php echo $language['language_id']; ?>][profitably]" value="0" />
                        <?php echo $text_no; ?>
                        <?php } ?>
                      </label>
                    </div>
                  ...
                  <select name="type_id">
                    <?php foreach ($types as $key => $type) { ?>
                      <?php if($type['type_id'] == $type_id) { ?>
                        <option selected value="<?php echo $type['type_id'];?>"><?php echo $type['name'];?></option>
                      <?php } else { ?>
...
$('#input-admission<?php echo $language['language_id']; ?>').summernote({height: 300});
$('#input-technical_info<?php echo $language['language_id']; ?>').summernote({height: 300});
