...
$('#log-clear').click(function() {
    if(confirm("<?php echo $text_confirm; ?>")) {
        $.get("index.php?route=module/log/clear&token=<?php echo $token; ?>", function() {
...
<script type="text/javascript"><!--
    $('#log-config-form').submit(function(event) {
        ...
        $.post("index.php?route=module/log/config&token=<?php echo $token; ?>", $("#log-config-form").serialize(), function() {
