...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_admission'] = $this->language->get('entry_admission');
		$data['entry_technical_info'] = $this->language->get('entry_technical_info');
                $data['entry_short_description'] = $this->language->get('entry_short_description');
                $data['entry_europe_quality'] = $this->language->get('entry_europe_quality');
                $data['entry_profitably'] = $this->language->get('entry_profitably');
		...
		$data['types'] =  $this->model_catalog_product_type->getTypes();
		...
		if (isset($this->request->post['type_id'])) {
			...
			$data['type_id'] = $product_info['type_id'];
		} else {
			$data['type_id'] = '';
		}
