...
class ControllerCatalogInformation extends Controller {
	...
	protected function validateDelete() {
		...
		if (isset($this->request->get['filter_name'])) {
                    ...
                    $results = $this->model_catalog_information->getInformations(array('filter_name'  => $this->request->get['filter_name']));
                    ...
                    foreach ($results as $result) {
                            $json[] = array(
                                    ...
                                    'title'          => $result['title'],
                                    'sort_order'     => $result['sort_order'],
                                    'edit'           => $this->url->link('catalog/information/edit', 'token=' . $this->session->data['token'] . '&information_id=' . $result['information_id'], 'SSL')
                            );
                    }
		}
