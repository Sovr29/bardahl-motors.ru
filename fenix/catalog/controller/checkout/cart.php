...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/cart_1.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/checkout/cart_1.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/checkout/cart_1.tpl', $data));
			}
		} else {
			$data['heading_title'] = $this->language->get('heading_title');
	...
	public function edit() {
		...
		if (!empty($this->request->post['quantity'])) {
			...
			if(isset($this->request->post["redirect"])){
                            if($this->request->post["redirect"] === "true"){
