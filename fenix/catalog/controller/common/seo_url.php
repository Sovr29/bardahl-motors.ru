		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				if ($query->num_rows) {
					...
					if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id' && $url[0] != 'news_id' && $url[0] != 'promotion_id') {			
		  ...
		  // Redirect 301	
			...
			if ($this->request->get['route'] == 'product/product' && isset($this->request->get['product_id'])) {
				...
				$this->request->get['route'] = 'news_id=' . $this->request->get['news_id'];
			} elseif ($this->request->get['route'] == 'information/promotions/promotion' && isset($this->request->get['promotion_id'])) {
				$this->request->get['route'] = 'promotion_id=' . $this->request->get['promotion_id'];
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				...
				if (($data['route'] == 'information/news/news' && $key == 'news_id') || ($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'information/promotions/promotion' && $key == 'promotion_id')) {
