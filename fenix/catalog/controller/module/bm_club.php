...
class ControllerModuleBmClub extends Controller {
	public function index() {
		...
		$this->load->model('tool/image');
                ...
                if(!($this->config->get('bm_club_status') == 1))
                {
                ...
                $category_id = $this->config->get('bm_club_category');
		$category_info = $this->model_catalog_category->getCategory($category_id, false);
