...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['tab_admission'] = $this->language->get('tab_admission');
			$data['tab_technical_info'] = $this->language->get('tab_technical_info');
			...
			$data['description'] = html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8');
                        ...
                        $data['admission'] = ($product_info['admission'] == '&lt;p&gt;&lt;br&gt;&lt;/p&gt;' ? '' : html_entity_decode($product_info['admission'], ENT_QUOTES, 'UTF-8'));
						$data['technical_info'] =  ($product_info['technical_info'] == '&lt;p&gt;&lt;br&gt;&lt;/p&gt;' ? '' : html_entity_decode($product_info['technical_info'], ENT_QUOTES, 'UTF-8'));
                        $data['sku'] = html_entity_decode($product_info['sku'], ENT_QUOTES, 'UTF-8');
                        
                        $data['europe_quality'] = $product_info['europe_quality'];
                        $data['profitably'] = $product_info['europe_quality'];
			...
			if ($this->config->get('config_google_captcha_status')) {
				...
				$data['site_key'] = '';
                        ...
                        $this->document->addScriptText("$(document).ready(function () {
                        ...
                        $('#review').load('index.php?route=product/product/review&product_id=". $data['product_id'] . "');
                        ...
                        $('#button-review').on('click', function () {
                            $.ajax({
                                url: 'index.php?route=product/product/write&product_id=". $data['product_id'] . "',
                                type: 'post',
                                dataType: 'json',
