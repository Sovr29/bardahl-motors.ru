...
class ControllerCheckout2Checkout2 extends Controller {
	...
	public function index() {
		...
		$this->document->setTitle($this->language->get('heading_title'));
                ...
                // checkout2 needs
                $this->document->addScript("//code.jquery.com/jquery-1.11.0.min.js");
                $this->document->addScript("//code.jquery.com/jquery-migrate-1.2.1.min.js");
                $this->document->addScript("catalog/view/theme/bardahl/slick/slick/slick.min.js");
                $this->document->addScript("http://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/jquery.validate.min.js");
                $this->document->addScript("catalog/view/theme/bardahl/js/oversell.js?v=1.02");
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('checkout2/checkout2', '', 'SSL')
		);
