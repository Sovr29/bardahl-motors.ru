<?php
class ControllerCheckout2ShippingMethod extends Controller {
	public function index() {
		...
		// Shipping Methods
                ...
                $view = '';
                $data['isAjax'] = $isAjax;
                if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout2/shipping_method.tpl')) {
                    $view = $this->load->view($this->config->get('config_template') . '/template/checkout2/shipping_method.tpl', $data);
                } else {
                    $view = $this->load->view('default/template/checkout2/shipping_method.tpl', $data);
                }
