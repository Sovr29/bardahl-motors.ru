...
class ControllerCheckout2Shipping extends Controller {
	public function index() {
		...
		if ($this->config->get('shipping_status') && $this->config->get('shipping_estimator') && $this->cart->hasShipping()) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout2/shipping.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/checkout2/shipping.tpl', $data);
			} else {
				return $this->load->view('default/template/checkout2/shipping.tpl', $data);
			}
		}
	...
	public function shipping() {
		...
		if (!empty($this->request->get['shipping_method'])) { // was post
